...
Wzór na pozycję punku masy $i$ w czasie $t + dt$ jest w modelu wyrażona wzorem:
...
gdzie $v_{ij} = v_i - v_j$, jest prędkością względną, a $\vec{v}_{ij} \cdot \vec{x}_{ij}$ jest 
